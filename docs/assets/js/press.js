$(document).ready(function(){
    ...
    $(':header').each(function(){
        ...
        var idH = texto.toLowerCase().replaceAll(' ','-').replaceAll('á','a').replaceAll('é','e').replaceAll('í','i').replaceAll('ó','o').replaceAll('ú','u').replaceAll('ñ','n');
        $(this).attr('id',idH);
        if(texto != 'Índice:' && texto != 'Contacto:'){
            $('aside ul').append('<li class="' + classH +'"><a href="#' + idH + '" class="aAside">' + texto + '</a></li>');
        }
